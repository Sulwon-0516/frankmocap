...
class DemoOptions():
    ...
    def __init__(self):
        ...
        # output options
        parser.add_argument('--out_dir', type=str, default='./mocap_output/exp6_3', help='Folder of output images.')
...
def mesh_from_output(pred_output_list, rot, imgSize):
    pred_mesh_list = list()
...
def crop_body_mocap(args, db, body_mocap, visualizer):
    ...
    for data in db:
        ...
        pred_mesh_list = mesh_from_output(pred_output_list, data['rot_mat'], imgSize)
